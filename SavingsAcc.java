...
public class SavingsAcc extends Bank {
	...
	public SavingsAcc(String usrname, String usrpwd, double amount, String accType) {
...
//	}
	...
	private void checkBalance() {
		System.out.println("Your Savings Account balance: " + amount);
	}
		...
		while (!isValid) {
			...
			if (damt1 >= 100) {
				...
				System.out.println("Your amount " + damt
						+ " successfully credited to your Savings Account...  Balance = " + amount);
				isValid = true;
			} else {
				System.out.println("Please enter 100 or above!");
				System.out.println("~~~~~~ ~~~~~ ~~~ ~~ ~~~~~");
